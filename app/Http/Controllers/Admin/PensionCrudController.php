...
class PensionCrudController extends CrudController
{
    ...
    {
        CRUD::column('Pension_Duree');
        CRUD::column('Pension_Type');
        CRUD::column('Prix_Adulte');
        CRUD::column('Prix_Ado');
        CRUD::column('Prix_Enfant');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('Pension_Duree');
        CRUD::field('Pension_Type');
        CRUD::field('Prix_Adulte');
        CRUD::field('Prix_Ado');
        CRUD::field('Prix_Enfant');
