...
class Enfant extends Model
{
    ...
    */
    ...
    {
        return '<a class="btn btn-xs btn-default" target="_blank" href="'.route('pfd',['title'=>"Info sur l'enfant",'type'=>'enfant','id'=>$this->id] ).'" data-toggle="tooltip" title="Télécharger"><i class="fa fa-download"></i> pdf</a>';
    }
}
