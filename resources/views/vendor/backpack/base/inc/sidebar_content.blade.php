...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('enfant') }}'><i class='nav-icon la la-child'></i> Enfants</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('famille') }}'><i class='nav-icon la la-users'></i> Familles</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('sejour') }}'><i class='nav-icon la la-suitcase'></i> Sejours</a></li>
