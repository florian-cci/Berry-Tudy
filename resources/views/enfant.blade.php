            ...
            <form action="./inscription" method="POST" id='inscriptionForm'>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label class='form-label' for="Inscription_Date_Naissance">Date de naissance<span
                                        class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="Inscription_Date_Naissance"
                                    placeholder="AAAA-MM-JJ" name="Inscription_Date_Naissance" required>
                            </div>
                        </div>
                ...
                <fieldset class="step">
                    ...
                    <div class="row">
                        ...
                        <div class='col form-group'>
                            <label class='form-label' for="Inscription_Situation_Classe">Classe<span
                                    class="text-danger">*</span></label>
                            <input class='form-control' type='text' name="Inscription_Situation_Classe" placeholder="Classe"
                                id="Inscription_Situation_Classe" required>
                        </div>
                    </div>
                    <hr>
                    <div class="row form-group">
                    ...
                    <div class='form-group'>
                        <label class='form-label' for="Inscription_Situation_Frere_Description">Si oui, veuillez
                            indiquer leurs prénoms et âges</label>
                        <input class='form-control' type='text' name="Inscription_Situation_Frere_Description"
                            placeholder="Prénom & age" id="Inscription_Situation_Frere_Description">
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <textarea class='form-control' name="Inscription_Situation_Description" placeholder="Problême familliaux"
                ...
                <fieldset class='step'>
                    ...
                    <div class='form-group'>
                        ...
                        <textarea class='form-control' name='Inscription_Groupe' id='Inscription_Groupe' rows='4'></textarea>
                    </div>
                ...
                <fieldset class="step">
                    ...
                    <div class='form-group'>
                        <label class="form-label" for="Inscription_Legal1_Employeur">Nom de l'employeur<span
                                class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="Inscription_Legal1_Employeur"
                            placeholder="Employeur" id="Inscription_Legal1_Employeur" required>
                    </div>
                ...
                <fieldset class="step">
                    ...
                    <div class="row form-group">
                        <div class="col">
                            <label class='form-label' for="Inscription_Regime_Porc">Sans porc ?<span
                                    class="text-danger">*</span></label>
                        </div>
                        <div class="col">
                            <div class="row">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="radio" name="Inscription_Regime_Porc"
                                        id="Inscription_Regime_Porc1" value='oui' required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="radio" name="Inscription_Regime_Porc"
                                        id="Inscription_Regime_Porc2" value='non' required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p>Conformément à la loi, l’Association BERRY-TUDY est couverte par les polices d’assurances pour les
                        biens
										...
										<div>
											<div class="form-group">
													<label class='form-label' for='Inscription_Caf_Numero'>N° d'allocataire C.A.F<span
																	class="text-danger">*</span></label>
													<input class="form-control" type="text" name="Inscription_Caf_Numero"
                ...
                <fieldset class="step">
                    ...
                    <div class='form-group'>
                        <label class="form-label" for="Inscription_Organisme_Qualite">Qualite</label>
                ...
                <fieldset class="step">
                    <legend class='text-center fs-2'>Qui prévenir en cas d'urgences ?</legend>
                    <hr>
                    <div class="row">
                        <div class="col form-group">
                ...
                <fieldset class='step'>
                    ...
                    <div class="row border-bottom border-bottom-2">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item text-center">• Favoriser l’accueil d’enfants de tous milieux et
                                origines</li>
                            <li class="list-group-item text-center">• Permettre la découverte de l’environnement, de la
                                culture bretonne</li>
                            <li class="list-group-item text-center">• Communiquer des convictions de partage, de respect,
                                d’accueil et de tolérance.</li>
                            <li class="list-group-item text-center">• Développer un centre accueillant et fonctionnel
...
@section('extra-js')
    ...
    <script src="./assets/js/formEnfantHandler.js"></script>
@endsection
